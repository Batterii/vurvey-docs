...
Click **+ Create Agent** in the top-right corner of the gallery to open a modal titled **Generate Agent**. You can choose to generate an agent quickly using AI, or manually configure one in the full builder.
